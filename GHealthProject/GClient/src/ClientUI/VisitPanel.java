...
public class VisitPanel extends JPanel {
	...
	public VisitPanel(Visit visit) {
		super();
		setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Visit Details", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		textField = new JTextField(visit.getTreatment().getDoctor().getFirstName()+""+visit.getTreatment().getDoctor().getLastName());
